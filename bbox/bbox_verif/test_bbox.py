...
#generates tests for instructions of RV64
    ...
    tf.add_option(('instr','instr_name','single_opd'), [(0b01100000000000000101000000110011, 'ror', 0), (0b01100000000000000101000000111011, 'rorw', 0), (0b01100000000000000101000000010011, 'rori_64',0 ), (0b01100000000000000101000000011011, 'roriw', 0), (0b01101011100000000101000000010011, 'rev8_64', 1)])
    #if instruction has single operand, provide single_opd = 1 (please see below line).
    ##To run multiple instr - tf.add_option(((('instr','instr_name','single_opd'), [(1, 'addn', 0),(2,'clz',1),(...)])
